...
<html>
	<head>
		<title>Datalagring | Homepal Sverige</title>
	...
	<body>
		...
		<div id='contentParent2' style='background-color: #ffffff;'>
			...
			<div class='contentSection5' style='margin-top: 0;'>
				<a class='webpageLinkSection' href='datalagring.html' style='background-color: #EAF4FF; border: 2px solid #7AA5D4;'>
					<p class='webpageLinkTitle'>Datalagring</p>
					<p class='webpageLink'>Läs om hur vi gör</p>
					<img class='webpageLinkIcon' src='1.png'>
				</a>
			...
			<div class='contentSection5' style='padding-bottom: 0;'>
				...
				<img class='largeTitleIllustration' src='samla.png'>
				
				<h1 class='largeTitle'>
					Det börjar med att allt kommer samman.
				</h1>
			</div>
			...
			<div class='contentSection5' style='padding-bottom: 0;'>
				...
				<img class='largeTitleIllustration' src='fel.png'>
				
				<h1 class='largeTitle' style='max-width: 650px;'>
					Ofta gömmer sig fel. Vi missar aldrig dem.
				</h1>
			</div>
			...
			<div class='contentSection5' style='padding-bottom: 0;'>
				...
				<img class='largeTitleIllustration inlast' src='inlåst.png'>
				
				<h1 class='largeTitle' style='max-width: 700px;'>
					Det är dags för dig att bli utsläppt.
				</h1>
			</div>
			...
			<div class='tinyTextSection'>
				...
				<img class='tinyTextImage' src='fullständighet1.png'>
				<img class='tinyTextImage' src='fullständighet2.png'>
			</div>
			...
			<div class='contentSection3'>
				...
				<div class='titleParent'>
					<h3 class='smallTitle3'><span style='color: #cccccc;'>Nästa steg</span><br>Integrationer</h3>
				</div>
			</div>
